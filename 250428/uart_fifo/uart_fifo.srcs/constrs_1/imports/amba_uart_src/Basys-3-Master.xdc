...
## LEDs
set_property -dict {PACKAGE_PIN U16    IOSTANDARD LVCMOS33} [get_ports  {GPIOD_INOUTPORT[0]}]
set_property -dict {PACKAGE_PIN E19    IOSTANDARD LVCMOS33} [get_ports  {GPIOD_INOUTPORT[1]}]
set_property -dict {PACKAGE_PIN U19    IOSTANDARD LVCMOS33} [get_ports  {GPIOD_INOUTPORT[2]}]
set_property -dict {PACKAGE_PIN V19    IOSTANDARD LVCMOS33} [get_ports  {GPIOD_INOUTPORT[3]}]
set_property -dict {PACKAGE_PIN W18    IOSTANDARD LVCMOS33} [get_ports  {GPIOD_INOUTPORT[4]}]
set_property -dict { PACKAGE_PIN U15   IOSTANDARD LVCMOS33 } [get_ports {GPIOD_INOUTPORT[5]}]
...
set_property -dict { PACKAGE_PIN T18   IOSTANDARD LVCMOS33 } [get_ports GPIOA_INOUTPORT[0]] 
